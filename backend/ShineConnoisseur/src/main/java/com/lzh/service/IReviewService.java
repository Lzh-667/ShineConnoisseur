...
public interface IReviewService extends IService<Review> {
    ...
    Result getUserReviews(Long userId, Integer current);
    ...
    Result getReviewDetail(Long reviewId);

    Result hotReviews(Integer current);

    void updateHotReviewCache();

    Result searchReviews(String keyword, Integer current, Integer spoiler);
}
